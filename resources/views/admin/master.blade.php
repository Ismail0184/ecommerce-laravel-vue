...
<head>
    <meta charset="utf-8" />
    <title>Manage your website | @yield('title')</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="you will be able to manage your website through the admin panel" name="description" />
    ...
    <div class="leftside-menu">
        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar>
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    <a href="{{route('sub_category.view')}}" class="side-nav-link">
