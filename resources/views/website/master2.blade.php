        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            <li><i class="ti-headphone-alt"></i> +880 1845854380</li>
            ...
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        <li class="active"><a href="blog-single.html">@yield('title')</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<!-- Fancybox JS -->
<script src="{{asset('/')}}website/assets/js/facnybox.min.js"></script>
<!-- Waypoints JS -->
...
<script src="{{asset('/')}}website/assets/js/gmap.min.js"></script>
